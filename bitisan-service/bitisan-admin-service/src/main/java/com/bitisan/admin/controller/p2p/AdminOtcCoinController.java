...
import static com.baomidou.mybatisplus.core.toolkit.Assert.isNull;
...
public class AdminOtcCoinController extends BaseAdminController {
    ...
    @Autowired
    private OtcCoinFeign otcCoinService;
    @Autowired
    ...
    public MessageResult deletes(
        ...
        return success(messageSource.getMessage("DELETE_ADDRESS_SUCCESS"));
    }
    ...
    public MessageResult pageQuery(PageParam pageParam) {
        Page<OtcCoin> pageResult = otcCoinService.findAllPage(pageParam);
