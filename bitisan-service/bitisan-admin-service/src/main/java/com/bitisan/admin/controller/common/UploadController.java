...
import com.bitisan.admin.config.AliyunConfig;
...
import com.bitisan.util.UploadFileUtil;
    ...
    public MessageResult base64UpLoad(@RequestParam String base64Data) {
        ...
        try {
            ...
            if (base64Data == null || "".equals(base64Data)) {
                throw new Exception(sourceService.getMessage("UPLOAD_FAILED_EMPTY_IMAGE"));
            } else {
                ...
                if (d != null && d.length == 2) {
                    ...
                    throw new Exception(sourceService.getMessage("UPLOAD_FAILED_INVALID_DATA"));
                }
            }
            ...
            if ("data:image/jpeg;".equalsIgnoreCase(dataPrix)) {//data:image/jpeg;base64,base64编码的jpeg图片数据
                ...
                throw new Exception(sourceService.getMessage("UPLOAD_INVALID_IMAGE_FORMAT"));
            }
            String directory = new SimpleDateFormat("yyyy/MM/dd/").format(new Date());
            String key = directory + GeneratorUtil.getUUID() + suffix;
            ...
            try {
                ...
                throw new Exception(sourceService.getMessage("UPLOAD_WRITE_FILE_FAILED") + ee.getMessage());
            }
        } catch (Exception e) {
            logger.debug("上传失败," + e.getMessage());
            result.setCode(500);
            result.setMessage(sourceService.getMessage("UPLOAD_FAILED") + e.getMessage());
        }
        return result;
    }
