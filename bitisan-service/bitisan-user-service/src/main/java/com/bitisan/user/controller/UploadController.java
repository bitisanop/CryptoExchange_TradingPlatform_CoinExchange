...
import com.bitisan.user.config.AliyunConfig;
...
public class UploadController {
     ...
     * @throws IOException
     */
    @ApiOperation(value = "上传图片到阿里云OSS")
    @PermissionOperation
     ...
     * @return
     */
    @ApiOperation(value = "上传base64处理后的图片")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "base64Data", value = "base64图片数据"),
    })
